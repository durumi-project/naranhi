...
│   └── data/
│       ├── cases/
│       │   ├── PENDING/            ← 검수 대기 사례 (61건, 세션 7 일괄 변환 후)
│       │   │   ├── DR-CASE-001.json ~ DR-CASE-050.json (50건, 047 단톡방 제외 49 + 047 = 50건)
│       │   │   │   ※ 모든 두루 50건 사례 변환 완료 (003·004·006·010·019·020·022·047은 세션 5·6 변환, 나머지는 세션 7)
│       │   │   ├── DR-PREC-001.json (2024구합24300, 첫 precedent)
│       │   │   ├── DR-PREC-002.json (2023구합23614, 피해 측 가중 청구 기각)
│       │   │   ├── DR-PREC-003.json (2023노1580, 학폭위원 비밀누설 형사, 첫 역할 P)
│       │   │   ├── DR-PREC-004.json (2022구합20199, 첫 SX, safety_flag=true)
│       │   │   ├── DR-PREC-005.json (2019누24497, 졸업 → 소 각하)
│       │   │   ├── DR-PREC-006.json (2024구합20339, 피해 청구로 학급교체→전학 변경, 두 번째 safety_flag=true)
│       │   │   ├── DR-PREC-007.json (2023구합21694, 첫 *학폭 불인정*)
│       │   │   ├── DR-PREC-008.json (2022나66828, 첫 민사 손해배상)
│       │   │   │   ※ DR-PREC-009(강제추행 형사)는 학생 노출 부담으로 SKIP, 010(버스기사 폭행)은 학폭 무관 제외
│       │   │   ├── OM2-IV-001.json
